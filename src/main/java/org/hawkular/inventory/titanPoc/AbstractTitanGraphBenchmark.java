...
public class AbstractTitanGraphBenchmark extends AbstractGraphBenchmark<TitanInventoryGraph> {
    ...
    public void testBasicBlueprintsApi() {
        List<TitanInventoryNode> nodes = inventoryGraph.nodes();
        nodes.forEach(node -> {
    ...
    private void insertSimpleInventory(TitanInventoryGraph inventoryGraph) {
        // vertices
